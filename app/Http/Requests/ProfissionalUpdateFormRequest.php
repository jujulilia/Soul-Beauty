    ...
    public function rules(): array
    {
        return [
            'nome' => 'required|max:120|min:5',
                ...
                'pais' => 'required|max:80|min:2',
                'rua' => 'required|max:120|min:3',
    ...
    public function messages()
{
    return [
        ...
        'pais.min' => 'O país deve conter no mínimo 2 caracteres',
        'rua.required' => 'A rua é obrigatória',
        'rua.max' => 'A rua deve conter no máximo 120 caracteres',
        'rua.min' => 'A rua deve conter no mínimo 3 caracteres',
        ...
        'bairro.min' => 'O número deve conter no mínimo 5 caracteres',
        ...
        'salario.decimal' => 'O salário deve ser numerico com 2 casas decimais',
    ];
